export default function Intro() {
    return (
      <section className="min-h-screen flex flex-col justify-end pb-20 px-8 md:px-16 relative overflow-hidden">
        <div className="absolute top-24 right-8 md:right-16 opacity-40">
          <span
        ...
        <div className="max-w-5xl">
          ...
          <h1
            className="leading-[0.92] tracking-tight text-[#F0EDE6] mb-8"
            style={{
          ...
          >
            Building things
            <br />
            <em className="text-[#E9B44C]">I can't stop</em>
            <br />
            thinking about.
          </h1>
